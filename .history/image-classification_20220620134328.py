...
def feature_extraction(file):   
    ...
    left_under_eye = edge_img[face_features.part(40).y:face_features.part(29).y+5, face_features.part(18).x:face_features.part(21).x]
    ...
    right_under_eye = edge_img[face_features.part(47).y:face_features.part(29).y+5, face_features.part(22).x:face_features.part(25).x]
    ...
    #draw feature zones
    #under eye
    cv2.rectangle(edge_img, (face_features.part(18).x, face_features.part(40).y+10), (face_features.part(21).x, face_features.part(29).y), (255,0,0), 2)
    cv2.rectangle(edge_img, (face_features.part(22).x, face_features.part(47).y+10), (face_features.part(25).x, face_features.part(29).y), (255,0,0), 2)
    #cheek
...
# result=feature_extraction('test\\under-20\\11679.png')
