...
# img = cv2.imread("images/<20/3.jpg")
img = cv2.imread("./test/under-20/11679.png")
...
#cheek
cv2.rectangle(img, (face_features.part(3).x, face_features.part(29).y), (face_features.part(48).x, face_features.part(54).y), (255,0,0), 2)
